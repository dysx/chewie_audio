...
import 'package:lighthouse/base/common/commonInsert.dart';
...
class _MaterialControlsState extends State<MaterialControls> {
            ...
            children: <Widget>[
              ...
              Container(
                ...
                child: chewieController.isLive
                    ...
                    : _buildPosition(iconColor, Color(0xFF999999)),
              )
            ],
          )
        ],
  ...
  GestureDetector _buildPlayPause(VideoPlayerController controller) {
    return GestureDetector(
      ...
      child: Container(
        ...
        child: controller.value.isPlaying ? LocalImageSelector.getPng('icon-pause', imageWidth: 10)
            : LocalImageSelector.getPng('icon-play', imageWidth: 10),
        // Icon(
  ...
  Widget _buildPosition(Color iconColor, Color textColor) {
